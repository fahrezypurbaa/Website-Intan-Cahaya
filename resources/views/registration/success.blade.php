...
<div class="min-h-screen flex items-center justify-center bg-gray-50 px-6 py-12">
    <div class="bg-white shadow-lg rounded-2xl p-10 max-w-xl w-full text-center border border-gray-100">
        ...
        <p class="text-gray-700 mb-2 text-lg">Terima kasih sudah mendaftar di <span class="font-semibold text-green-700">Intan Safety Jogja</span>.</p>
        <p class="text-gray-500 mb-8">Silakan hubungi admin via WhatsApp untuk melanjutkan proses berkas & pembayaran.</p>
