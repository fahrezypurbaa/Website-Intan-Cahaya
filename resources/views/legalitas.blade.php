        ...
        @php
            $legalitas = [
                [
                    ...
                    'desc'  => 'Surat Keputusan Direktorat Jenderal Pembinaan Pengawasan Ketenagakerjaan Nomor 5/348/AS.02.00/III/2021.',
        ...
        @foreach($legalitas as $doc)
            <div class="bg-white shadow rounded-xl overflow-hidden hover:shadow-lg transition">
                <div class="relative">
                    ...
                    <div class="absolute inset-0 bg-black/40 opacity-0 hover:opacity-100 flex items-center justify-center text-white transition">
                        🔍 Klik untuk perbesar
                    </div>
                </div>
                <div class="p-4">
