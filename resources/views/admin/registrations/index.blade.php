    ...
    <x-admin.table>
        ...
        @forelse($registrations as $index => $reg)
            <tr class="hover:bg-gray-50 transition">
                ...
                <!-- Tampilkan kota sesuai tipe peserta -->
                <td class="px-4 py-3 text-gray-700">
                ...
                <td class="px-4 py-3 text-gray-700">{{ $reg->training->title ?? '-' }}</td>
                <td class="px-4 py-3 text-gray-700">{{ $reg->training->category->name ?? '-' }}</td>
