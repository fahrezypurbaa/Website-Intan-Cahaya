...
@section('title', 'Tambah Artikel - Intan Safety')

@section('content')
<div class="max-w-5xl mx-auto bg-white shadow-md rounded-xl p-8">
    <h1 class="text-2xl font-bold text-[#144F5F] mb-6">Tambah Artikel Baru</h1>
    ...
    <form action="{{ route('admin.articles.store') }}" method="POST" enctype="multipart/form-data" class="space-y-6">
        ...
        <div>
            ...
            {{-- Slug (opsional, otomatis dari judul) --}}
            <div class="mb-4">
            ...
            <div class="mb-4">
                ...
                <div id="preview-container" class="mt-3 hidden">
                    ...
                    <img id="preview-thumbnail" class="w-48 h-32 object-cover rounded-lg border">
                </div>
            </div>
        </div>
        ...
        <div>
            ...
            <div class="mb-4">
                ...
                <textarea name="excerpt" id="excerpt" rows="3"
                    class="w-full border-gray-300 rounded-lg focus:ring-[#144F5F] focus:border-[#144F5F]" 
                    placeholder="Tuliskan ringkasan singkat artikel...">{{ old('excerpt') }}</textarea>
            </div>
        ...
        <div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                    ...
                    <input type="text" name="author_name" id="author_name" value="{{ old('author_name', 'Admin') }}"
                        class="w-full border-gray-300 rounded-lg focus:ring-[#144F5F] focus:border-[#144F5F]">
                </div>
                ...
                <div>
                    ...
                    <input type="text" name="author_bio" id="author_bio" value="{{ old('author_bio') }}"
                        class="w-full border-gray-300 rounded-lg focus:ring-[#144F5F] focus:border-[#144F5F]" 
                ...
                <div>
                    ...
                    <textarea name="meta_description" id="meta_description" rows="3"
                        class="w-full border-gray-300 rounded-lg focus:ring-[#144F5F] focus:border-[#144F5F]" 
                        placeholder="Deskripsi singkat untuk SEO">{{ old('meta_description') }}</textarea>
                </div>
            </div>
        </div>
