...
@section('content')
    <x-admin.form-wrapper title="✏️ Edit Training" action="{{ route('admin.trainings.update', $training->id) }}" method="POST"
        submit="💾 Update Training" back="{{ route('admin.trainings.index') }}" enctype="multipart/form-data">
        @method('PUT')
